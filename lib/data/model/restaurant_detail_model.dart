...
RestaurantDetailResult welcomeFromJson(String str) => RestaurantDetailResult.fromJson(json.decode(str));

String welcomeToJson(RestaurantDetailResult data) => json.encode(data.toJson());
